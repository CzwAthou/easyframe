...
public class VideoUtil {
    ...
    public static Bitmap createVideoThumbnail(String path) {
        File file = AbFileUtil.openFile(path, false);
        if (file == null) {
            return null;
        }
        Bitmap bitmap = null;
    ...
    public static long getVideoLength(String videoPath) {
        ...
        try {
            ...
            video_length = Long.parseLong(media.extractMetadata(android.media.MediaMetadataRetriever.METADATA_KEY_DURATION));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return video_length;
    ...
    public static long getVideoSize(String videoPath) {
        return AbFileUtil.getFileSize(videoPath);
    }
    ...
    public static Map<String, Object> parseVideo(Context context, String videoPath) {
        File file = AbFileUtil.openFile(videoPath, false);
        if (file == null) {
            return null;
        }
