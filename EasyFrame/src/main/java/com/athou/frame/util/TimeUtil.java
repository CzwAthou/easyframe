...
public final class TimeUtil {
    ...
    public static final long MILLISECOND_EVERYDAY = 86400000L;
    public static final long SECOND_EVERYDAY = 86400L;
    ...
    public static String getDateStringWithDateString(String otherDateStr, String fromFormate, String toFormate) {
        if (AbStrUtil.isEmpty(otherDateStr) || AbStrUtil.isEmpty(fromFormate) || AbStrUtil.isEmpty(toFormate)) {
            return null;
        }
...
//		int years = 0;
//		if (!AbStrUtil.isEmpty(secondTime)) {
                ...
                for (String str : dateAndTime) {
                    if (str.indexOf("-") != -1) {
                        ...
                        for (int i = 0; i < date.length; i++) {
                            String str1 = date[i];
                            sb.append(AbStrUtil.strFormatTwoPlace(str1));
                            if (i < date.length - 1) {
                                sb.append("-");
                            }
                        }
